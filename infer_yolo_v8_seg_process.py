...
# --------------------
class InferYoloV8Seg(dataprocess.CInstanceSegmentationTask):
...
# --------------------
class InferYoloV8SegFactory(dataprocess.CTaskFactory):
    ...
    def create(self, param=None):
        ...
        return InferYoloV8Seg(self.info.name, param)
